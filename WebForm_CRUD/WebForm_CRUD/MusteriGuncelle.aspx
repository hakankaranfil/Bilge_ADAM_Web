<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MusteriGuncelle.aspx.cs" Inherits="WebForm_CRUD.MusteriGuncelle" %>
...
<body>
    ...
    <div>
     <table border="1" class="table">
                ...
                <tr>
                    <td colspan="2">
                        <asp:Button ID="BtnGuncelle" class="btn btn-primary btn-block" runat="server" Text="Güncelle" OnClick="BtnGuncelle_Click" />
                    </td>
                </tr>
            </table>
    </div>
